...
describe('<TextInput />', () => {
  test('should have a value of searchValue', () => {
    ...
    render(<TextInput handleChange={fn} searchValue={'texto digitado do input'} />);
  ...
  test('should match snapshot', () => {
    ...
    const { container } = render(<TextInput handleChange={fn} searchValue={'texto digitado do input'} />);
